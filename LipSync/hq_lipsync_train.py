...
from models import LipSync, LipSync_disc_qual
import audio
...
parser = argparse.ArgumentParser(description='Code to train the LipSync model WITH the visual quality discriminator')
...
if __name__ == "__main__":
    ...
    device = torch.device("cuda" if use_cuda else "cpu")
     ...
     # Model
    model = LipSync().to(device)
    disc = LipSync_disc_qual().to(device)
